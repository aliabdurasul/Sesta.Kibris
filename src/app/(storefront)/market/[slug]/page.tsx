      ...
      <div className="mb-6 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100">
          ...
          {whatsappUrl && merchantForOwner.whatsapp_phone && (
            <a
              ...
              className="mt-3 inline-flex items-center gap-2 rounded-xl bg-[#25D366]/10 px-4 py-2.5 text-sm font-semibold text-[#128C7E] ring-1 ring-[#25D366]/30 transition-colors hover:bg-[#25D366]/15"
            >
              <svg
              ...
              WhatsApp · {formatWhatsAppDisplay(merchantForOwner.whatsapp_phone)}
            </a>
          )}
          {!merchantForOwner.is_open && (
